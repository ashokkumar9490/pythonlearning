...
def create_app(db_url=None):
    ...
    #     'DATABASE_URL', 'mongodb+srv://localhost:27017/stores_db')

    # add a mongodb database uri
    app.config["SQLALCHEMY_DATABASE_URI"] = os.getenv(
        'DATABASE_URL', 'mongodb://localhost:27017/stores_db')
    ...
    #     db.create_all()
    # not needed anymore as we are using the Alembic migration tool
